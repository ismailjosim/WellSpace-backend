...
const changeProfileStatus = catchAsync(async (req: Request, res: Response) => {
  ...
  const result = await UserServices.changeProfileStatusIntoDB(req.user as JwtPayload, id, status);
  sendResponse(res, {
    success: true,
    statusCode: HttpStatus.OK,
...
const updateMyProfile = catchAsync(async (req: Request, res: Response) => {
  const result = await UserServices.updateMyProfileIntoDB(req.user as JwtPayload, req);
  sendResponse(res, {
    success: true,
    statusCode: HttpStatus.OK,
